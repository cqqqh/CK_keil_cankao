...
void USB_Init (void) {
  ...
  GPIOD->BSRR =  0x0100;                    /* set PD8 */
  GPIOD->CRH &= ~0x0000000F;                /* clear port PD8 */
  GPIOD->CRH |=  0x00000003;                /* PD8 General purpose output push-pull, max speed 50 MHz */
}
